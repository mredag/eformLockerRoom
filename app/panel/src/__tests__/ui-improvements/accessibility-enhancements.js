...
(function() {
    ...
    class AccessibilityEnhancer {
        ...
        improveTouchAccessibility() {
            ...
            const touchElements = document.querySelectorAll('.locker-owner.selectable');
            touchElements.forEach(element => {
                ...
                element.addEventListener('touchend', (e) => {
                    ...
                    if (!touchMoved && touchDuration > 50 && touchDuration < 2000) {
                        // Valid touch interaction
                        element.click();
                    }
                }, { passive: true });
            });
        ...
        addScreenReaderSupport() {
            ...
            if (originalShowLoading) {
                window.showLoading = (message) => {
                    ...
                    this.announceToScreenReader(message || 'Yükleniyor...');
                };
            }
